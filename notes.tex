...
\label{figure-square-root-regression}
\end{figure}
...
\label{figure-exponential-regression}
\end{figure}
...
It's graph is Figure \ref{figure-discontinuous-piecewise}.
...
\label{figure-discontinuous-piecewise}
\end{figure}
...
\label{figure-tangent-lines-circle}
\end{figure}
...
\label{figure-curve-sketching-example3}
\end{figure}
...
\label{figure-model-radioactivity}
\end{figure}
...
\label{figure-temperature-model}
\end{figure}
